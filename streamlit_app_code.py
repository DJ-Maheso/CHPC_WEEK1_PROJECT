...
with dataset:
    ...
    st.text('This is the GRB dummy data. The GRB data is usually a few GB and I am trying streamlit and GitHUb for the first time so I used dummy data')
...
with modeltraining:
    ...
    st.text('Given the model, let's change the redshift and see what happens')
    sel_col, disp_col = st.columns(2)
    st.text('The redshift of GRBs is slitly above 0 and in a few cases its vey close to 10 hence the selected min and max values') 
